...
public final class SpinnerItemBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView spinnerItemLayout;

  private SpinnerItemBinding(@NonNull TextView rootView, @NonNull TextView spinnerItemLayout) {
  ...
  public static SpinnerItemBinding bind(@NonNull View rootView) {
    ...
    TextView spinnerItemLayout = (TextView) rootView;

    return new SpinnerItemBinding((TextView) rootView, spinnerItemLayout);
  }
}
